...
_TILEPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tiles_from_axis', full_name='caffe.TileParameter.tiles_from_axis', index=2,
      number=3, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
InnerProductBlobParameter = _reflection.GeneratedProtocolMessageType('InnerProductBlobParameter', (_message.Message,), dict(
  DESCRIPTOR = _INNERPRODUCTBLOBPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.InnerProductBlobParameter)
  ))
_sym_db.RegisterMessage(InnerProductBlobParameter)
