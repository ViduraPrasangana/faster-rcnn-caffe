...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional .caffe.PSROIPoolingParameter psroi_pooling_param = 148;
  inline bool has_psroi_pooling_param() const;
  inline void clear_psroi_pooling_param();
  static const int kPsroiPoolingParamFieldNumber = 148;
  ...
  // optional .caffe.InnerProductBlobParameter inner_product_blob_param = 149;
  inline bool has_inner_product_blob_param() const;
  inline void clear_inner_product_blob_param();
  static const int kInnerProductBlobParamFieldNumber = 149;
  inline const ::caffe::InnerProductBlobParameter& inner_product_blob_param() const;
  inline ::caffe::InnerProductBlobParameter* mutable_inner_product_blob_param();
  inline ::caffe::InnerProductBlobParameter* release_inner_product_blob_param();
  inline void set_allocated_inner_product_blob_param(::caffe::InnerProductBlobParameter* inner_product_blob_param);

  // optional .caffe.SmoothL1LossParameter smooth_l1_loss_param = 150;
  inline bool has_smooth_l1_loss_param() const;
  inline void clear_smooth_l1_loss_param();
  static const int kSmoothL1LossParamFieldNumber = 150;
  ...
  // optional .caffe.BoxAnnotatorOHEMParameter box_annotator_ohem_param = 151;
  inline bool has_box_annotator_ohem_param() const;
  inline void clear_box_annotator_ohem_param();
  static const int kBoxAnnotatorOhemParamFieldNumber = 151;
 ...
 private:
  ...
  inline void set_has_inner_product_blob_param();
  inline void clear_has_inner_product_blob_param();
...
class InnerProductBlobParameter : public ::google::protobuf::Message {
 public:
  InnerProductBlobParameter();
  virtual ~InnerProductBlobParameter();

  InnerProductBlobParameter(const InnerProductBlobParameter& from);

  inline InnerProductBlobParameter& operator=(const InnerProductBlobParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const InnerProductBlobParameter& default_instance();

  void Swap(InnerProductBlobParameter* other);

  // implements Message ----------------------------------------------

  InnerProductBlobParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const InnerProductBlobParameter& from);
  void MergeFrom(const InnerProductBlobParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // optional bool transpose = 1 [default = true];
  inline bool has_transpose() const;
  inline void clear_transpose();
  static const int kTransposeFieldNumber = 1;
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static InnerProductBlobParameter* default_instance_;
};
// -------------------------------------------------------------------
...
class TileParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional int32 tiles_from_axis = 3;
  inline bool has_tiles_from_axis() const;
  inline void clear_tiles_from_axis();
  static const int kTilesFromAxisFieldNumber = 3;
  inline ::google::protobuf::int32 tiles_from_axis() const;
  inline void set_tiles_from_axis(::google::protobuf::int32 value);
 ...
 private:
  ...
  inline void set_has_tiles_from_axis();
  inline void clear_has_tiles_from_axis();
  ...
  ::google::protobuf::int32 tiles_from_axis_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
  friend void protobuf_ShutdownFile_caffe_2eproto();
...
// optional .caffe.InnerProductBlobParameter inner_product_blob_param = 149;
inline bool LayerParameter::has_inner_product_blob_param() const {
  return (_has_bits_[1] & 0x10000000u) != 0;
}
inline void LayerParameter::set_has_inner_product_blob_param() {
  _has_bits_[1] |= 0x10000000u;
}
inline void LayerParameter::clear_has_inner_product_blob_param() {
  _has_bits_[1] &= ~0x10000000u;
}
inline void LayerParameter::clear_inner_product_blob_param() {
  if (inner_product_blob_param_ != NULL) inner_product_blob_param_->::caffe::InnerProductBlobParameter::Clear();
  clear_has_inner_product_blob_param();
}
inline const ::caffe::InnerProductBlobParameter& LayerParameter::inner_product_blob_param() const {
  // @@protoc_insertion_point(field_get:caffe.LayerParameter.inner_product_blob_param)
  return inner_product_blob_param_ != NULL ? *inner_product_blob_param_ : *default_instance_->inner_product_blob_param_;
}
inline ::caffe::InnerProductBlobParameter* LayerParameter::mutable_inner_product_blob_param() {
  set_has_inner_product_blob_param();
  if (inner_product_blob_param_ == NULL) inner_product_blob_param_ = new ::caffe::InnerProductBlobParameter;
  // @@protoc_insertion_point(field_mutable:caffe.LayerParameter.inner_product_blob_param)
  return inner_product_blob_param_;
}
inline ::caffe::InnerProductBlobParameter* LayerParameter::release_inner_product_blob_param() {
  clear_has_inner_product_blob_param();
  ::caffe::InnerProductBlobParameter* temp = inner_product_blob_param_;
  inner_product_blob_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_inner_product_blob_param(::caffe::InnerProductBlobParameter* inner_product_blob_param) {
  delete inner_product_blob_param_;
  inner_product_blob_param_ = inner_product_blob_param;
  if (inner_product_blob_param) {
    set_has_inner_product_blob_param();
  } else {
    clear_has_inner_product_blob_param();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.LayerParameter.inner_product_blob_param)
}
...
// optional bool transpose = 1 [default = true];
inline bool InnerProductBlobParameter::has_transpose() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void InnerProductBlobParameter::set_has_transpose() {
  _has_bits_[0] |= 0x00000001u;
}
inline void InnerProductBlobParameter::clear_has_transpose() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void InnerProductBlobParameter::clear_transpose() {
  transpose_ = true;
  clear_has_transpose();
}
inline bool InnerProductBlobParameter::transpose() const {
  // @@protoc_insertion_point(field_get:caffe.InnerProductBlobParameter.transpose)
  return transpose_;
}
inline void InnerProductBlobParameter::set_transpose(bool value) {
  set_has_transpose();
  transpose_ = value;
  // @@protoc_insertion_point(field_set:caffe.InnerProductBlobParameter.transpose)
}
...
// optional int32 tiles_from_axis = 3;
inline bool TileParameter::has_tiles_from_axis() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void TileParameter::set_has_tiles_from_axis() {
  _has_bits_[0] |= 0x00000004u;
}
inline void TileParameter::clear_has_tiles_from_axis() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void TileParameter::clear_tiles_from_axis() {
  tiles_from_axis_ = 0;
  clear_has_tiles_from_axis();
}
inline ::google::protobuf::int32 TileParameter::tiles_from_axis() const {
  // @@protoc_insertion_point(field_get:caffe.TileParameter.tiles_from_axis)
  return tiles_from_axis_;
}
inline void TileParameter::set_tiles_from_axis(::google::protobuf::int32 value) {
  set_has_tiles_from_axis();
  tiles_from_axis_ = value;
  // @@protoc_insertion_point(field_set:caffe.TileParameter.tiles_from_axis)
}
